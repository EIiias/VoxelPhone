...
public class PluginConfig {
    ...
    PluginConfig() {
        ...
        //Load existing config file
            ...
            try {
                configuration.load(new File(configFileLocation));
            } catch (IOException e) {
    ...
    public void loadPluginConfig() {
        ...
        databaseConnectionString = (String) configuration.get("database_connection_string");
        databaseUsername = (String) configuration.get("database_username");
        databasePassword = (String) configuration.get("database_password");
    }
}
